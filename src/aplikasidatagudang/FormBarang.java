...
public class FormBarang extends javax.swing.JFrame {
    String[] Kolom = {"ID Barang","Nama Barang","Tanggal","Kategori","gudang","Jumlah","Keterangan"};
    String sql = "SELECT * FROM tb_barang";
    int[] lebar = {70,150,100,70,250,70,400};

    /**
     * Creates new form FromBarang
     */
    public FormBarang() {
        config formBarang = new config();
        initComponents();
        this.setLocationRelativeTo(null);
        formBarang.settingKolomTabel(tblBarang, Kolom);
        formBarang.tampilIsiTabel(tblBarang, sql, Kolom);
        formBarang.settingLebarKolomTabel(tblBarang, lebar);
    }
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            if(txtID.getText().trim().equals("")){
                ...
                String[] field = {"id_barang","nama_barang","tanggal","kategori","gudang","jumlah","keterangan"};
                String[] isi = {txtID.getText(),txtNama.getText(),tanggal,(String) jComboBox1.getSelectedItem(),(String) jComboBox2.getSelectedItem(),txtJumlah.getText(),jTextArea1.getText()};
                new config().Simpan("tb_barang", field, isi);
                new config().settingKolomTabel(tblBarang, Kolom);
                new config().tampilIsiTabel(tblBarang, sql, Kolom);
                new config().settingLebarKolomTabel(tblBarang, lebar);
            }
        } catch (Exception e){
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        try{
            ...
            SimpleDateFormat format = new SimpleDateFormat(date);
            String tanggal = String.valueOf(format.format(jDateChooser1.getDate()));
//            String[] field = {"id_barang","nama_barang","tanggal","kategori","jumlah","keterangan"};
//            String[] isi = {txtID.getText(),txtNama.getText(),tanggal,(String) jComboBox1.getSelectedItem(),txtJumlah.getText(),jTextArea1.getText()};
            String SQL = "UPDATE tb_barang SET id_barang = '"+txtID.getText()+"', nama_barang = '"+txtNama.getText()+"', tanggal = '"+tanggal+"',kategori= '"+jComboBox1.getSelectedItem()+"',gudang= '"+jComboBox2.getSelectedItem()+"',jumlah= '"+txtJumlah.getText()+"',keterangan= '"+jTextArea1.getText()+"' WHERE id_barang = '"+txtID.getText()+"'";
    ...
    private void tblBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBarangMouseClicked
        try {                                       
            ...
            txtID.setText(tblBarang.getModel().getValueAt(row,0).toString());
            txtNama.setText(tblBarang.getModel().getValueAt(row,1).toString());
            jDateChooser1.setDate(new config().getTanggalTabel(tblBarang,2));
            jComboBox1.setSelectedItem(tblBarang.getModel().getValueAt(row,3).toString());
            jComboBox2.setSelectedItem(tblBarang.getModel().getValueAt(row,4).toString());
            txtJumlah.setText(tblBarang.getModel().getValueAt(row,5).toString());
            jTextArea1.setText(tblBarang.getModel().getValueAt(row,6).toString());
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        // TODO add your handling code here:
        try{
            new config().Hapus("tb_barang", "id_barang", txtID.getText());
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        // TODO add your handling code here:
        try{
            String SQL = "SELECT*FROM tb_barang WHERE id_barang LIKE '%"+txtCari.getText()+"%'OR nama_barang LIKE '%"+txtCari.getText()+"%'"; 
            Connection conn=(Connection)config.getkoneksiDB();
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        // TODO add your handling code here:
        try {
            String files = "src/Report/LaporanBarang.jasper";
